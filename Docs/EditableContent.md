...
now holds **302 blocks**, because #1390 (2026-09-24) replaced §18.9's Unprinted Material footer with
a re-keyed one and added four short templates after it — a row's footnote-first title, its VoiceOver
form, the same-lot marker and the number for rows worded alike — shorter than the sweep's rule, and
carried because they replaced the unit-only row the old footer sat under.*
