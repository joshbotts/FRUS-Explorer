...
<!-- SOURCE: FRUSExplorer/App/FRUSExplorerApp.swift | IOSFindMenuContent / FindMenuContent | lines: 3748–3748, 4240–4240 | key: menu.find.searchTips | shared: iOS+macOS (declared in BOTH — edit both call sites) -->
...
<!-- Shared: the same key is used from the editor, the list, and the Mac manager (three call
     ...
     are untouched. -->
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 289–290 | key: archiveVisit.delete.message -->
...
#### Deriving
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 346–347 | key: archiveVisit.editor.deriving -->
...
#### No documents seeded
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 635–636 | key: archiveVisit.editor.noSeeds.title -->

No documents seeded

<!-- END SOURCE: archiveVisit.editor.noSeeds.title -->

<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 639–640 | key: archiveVisit.editor.noSeeds.detail -->
...
#### Title
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 565–566 | key: archiveVisit.info.title -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 568–569 | key: archiveVisit.info.body -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 571–572 | key: archiveVisit.info.sparsity -->
...
#### Removing an orphan
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 225–226 | key: archiveVisit.orphan.remove.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 263–264 | key: archiveVisit.reseed.topic.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 256–257 | key: archiveVisit.reseed.topic.keep -->
...
<!-- SOURCE: FRUSExplorer/App/FRUSExplorerApp.swift | FRUSExplorerApp.handleDeepLink | lines: 3025–3026 | key: deepLink.inAppOnly %@ -->
