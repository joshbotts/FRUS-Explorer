...
<!-- SOURCE: FRUSExplorer/TripPacket/MacArchiveVisitManagerView.swift | lines: 145–146 | key: archiveVisit.mac.noSelection.title -->

No Archives Visit Selected

<!-- END SOURCE: archiveVisit.mac.noSelection.title -->

<!-- SOURCE: FRUSExplorer/TripPacket/MacArchiveVisitManagerView.swift | lines: 149–150 | key: archiveVisit.mac.noSelection.detail -->
...
<!-- Shared: the same key is used from the editor, the list, and the Mac manager (three call
     ...
     are untouched. -->
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 323–324 | key: archiveVisit.delete.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 742–743 | key: archiveVisit.editor.summary.v3 -->
...
<!-- Phase 4's honesty line: targets derive from the search index, so unindexed seeding documents
     ...
     and `\(seeding)` intact. -->
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 755–756 | key: archiveVisit.editor.coverage.v3 -->
...
#### Deriving
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 380–381 | key: archiveVisit.editor.deriving -->
...
#### No documents seeded
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 714–715 | key: archiveVisit.editor.noSeeds.title -->

No documents seeded

<!-- END SOURCE: archiveVisit.editor.noSeeds.title -->

<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 718–719 | key: archiveVisit.editor.noSeeds.detail -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | ArchiveVisitEditorView.filterToolbarMenu | lines: 629–630 | key: archiveVisit.filter.menu.help | shared: macOS only -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | ArchiveVisitEditorView.exportToolbarItem | lines: 454–455 | key: archiveVisit.editor.export.help | shared: iOS+macOS (single edit point — the Mac's tooltip; VoiceOver's hint alone at regular width, on iPad and on a large iPhone in landscape) -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | ArchiveVisitEditorView.infoToolbarItem | lines: 485–486 | key: archiveVisit.editor.about.help | shared: iOS+macOS (single edit point — the Mac's tooltip; VoiceOver's hint alone at regular width, on iPad and on a large iPhone in landscape) -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | ArchiveVisitEditorView.moreToolbarItem | lines: 503–504 | key: archiveVisit.editor.more.help | shared: macOS only -->
...
#### Title
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 644–645 | key: archiveVisit.info.title -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 647–648 | key: archiveVisit.info.body -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 650–651 | key: archiveVisit.info.sparsity -->
...
#### Removing an orphan
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 259–260 | key: archiveVisit.orphan.remove.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 297–298 | key: archiveVisit.reseed.topic.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 290–291 | key: archiveVisit.reseed.topic.keep -->
...
<!-- SOURCE: FRUSExplorer/ProjectContext/ProjectHomeView.swift | ProjectHomeView.reachCaption | lines: 774–778 | key: project.reach.caption %lld %lld -->
...
<!-- SOURCE: FRUSExplorer/ProjectContext/ProjectHomeView.swift | ProjectHomeView.leadsSection | lines: 813–814 | key: project.home.leads.placeholder -->
...
<!-- SOURCE: FRUSExplorer/ProjectContext/ProjectHomeView.swift | ProjectHomeView.recentSection | lines: 1093–1094 | key: project.home.recent.empty -->
...
<!-- SOURCE: FRUSExplorer/ProjectContext/ProjectHomeView.swift | ProjectCollectionsEditor.body | lines: 1340–1341 | key: project.collections.manage.footer -->
...
<!-- SOURCE: FRUSExplorer/ProjectContext/ProjectHomeView.swift | ProjectFocusTagsEditor.body | lines: 1490–1491 | key: project.focusTags.empty.detail -->
...
<!-- SOURCE: FRUSExplorer/ProjectContext/ProjectHomeView.swift | ProjectReachVolumeRow.body | lines: 1596–1597 | key: project.reach.volumeDetail %lld %lld -->
