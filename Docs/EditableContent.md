...
<!-- SOURCE: FRUSExplorer/App/FRUSExplorerApp.swift | IOSFindMenuContent / FindMenuContent | lines: 3725–3725, 4217–4217 | key: menu.find.searchTips | shared: iOS+macOS (declared in BOTH — edit both call sites) -->
