...
<!-- Shared: the same key is used from the editor, the list, and the Mac manager (three call
     ...
     are untouched. -->
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 292–293 | key: archiveVisit.delete.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 695–696 | key: archiveVisit.editor.summary.v2 -->
...
<!-- Phase 4's honesty line: targets derive from the search index, so unindexed seeding documents
     ...
     intact. -->
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 700–701 | key: archiveVisit.editor.coverage.v2 -->
...
#### Deriving
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 349–350 | key: archiveVisit.editor.deriving -->
...
#### No documents seeded
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 668–669 | key: archiveVisit.editor.noSeeds.title -->

No documents seeded

<!-- END SOURCE: archiveVisit.editor.noSeeds.title -->

<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 672–673 | key: archiveVisit.editor.noSeeds.detail -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 1172–1173 | key: archiveVisit.editor.noTargets -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 1169–1170 | key: archiveVisit.editor.allOff -->
...
#### Title
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 598–599 | key: archiveVisit.info.title -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 601–602 | key: archiveVisit.info.body -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 604–605 | key: archiveVisit.info.sparsity -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 1216–1217 | key: archiveVisit.info.sparsity.measured.v2 -->
...
#### Tiers footer
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 1606–1607 | key: archiveVisit.tiers.footer -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 1141–1142 | key: archiveVisit.orphan.caption -->
...
#### Removing an orphan
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 228–229 | key: archiveVisit.orphan.remove.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 914–915 | key: archiveVisit.target.substitute -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 994–995 | key: archiveVisit.seeding.inherited -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 1194–1195 | key: archiveVisit.documents.footer -->
...
#### Export packet — the editor's toolbar tooltip
<!-- The plan editor's Export packet toolbar button draws as an icon alone on the Mac, so this
     tooltip is where it says what the packet holds (#1378). It names the three parts What to
     Include turns on by default and the sheet's two share buttons (Share, Share as PDF); keep it
     in step with both. The button's label, "Export packet", is shared with the iPhone menu's item
     and the Mac ⋯ menu's, and the macOS manual names it — keep all three one wording. -->
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | ArchiveVisitEditorView.exportToolbarItem | lines: 423–424 | key: archiveVisit.editor.export.help | shared: macOS + iPad at regular width (single edit point) -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 266–267 | key: archiveVisit.reseed.topic.message -->
...
<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 259–260 | key: archiveVisit.reseed.topic.keep -->

Keep Current Topic

<!-- END SOURCE: archiveVisit.reseed.topic.keep -->

<!-- SOURCE: FRUSExplorer/TripPacket/ArchiveVisitEditorView.swift | lines: 1411–1412 | key: archiveVisit.reseed.topic.filled -->
