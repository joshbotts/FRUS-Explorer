...
Exports always include the collection title and a linked table of contents. The file is written to a temporary location first; the **Export Complete** sheet offers **Reveal in Finder** and **Save To…** (Return) to copy it where you want it.
