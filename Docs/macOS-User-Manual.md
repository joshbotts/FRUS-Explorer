...
[SCREENSHOT: the Archives Visits window with a plan's packet open from ⋯ ▸ Export packet — a target's two claim lists visible, the Options menu open showing the repository scope, and the Share buttons.]
