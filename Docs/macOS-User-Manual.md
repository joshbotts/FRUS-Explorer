...
The same person often appears across many volumes under different name forms ("Kissinger, Henry A.", "Kissinger, Henry", "Kissinger, Henry A. Laurence"). FRUS Explorer consolidates these into **one identity**, so you aren't chasing one person through a dozen entries. Each row shows the canonical name; a subtitle with the **role** a volume's List of Persons gives and the **active years** (*Secretary of State · 1973–1977*); and a **mention count** — the number of distinct documents referencing this identity across your indexed corpus. The active years run from the earliest to the latest year the volumes themselves give for the person: the years in their Lists of Persons, read by the words around them (*until January 3, 1979* is when someone left, *from June 13, 1982* when they began), and the dates of the indexed documents that mention them — never a preface or other front matter, which is dated when the volume was prepared, and never a birth or death year. A search field filters by name.
