...
| A8 | 🆕 `ipad/archives-axis.png` | iOS §6.1g placeholder | Browse ▸ Archives: the Provenance Types doors with counts; the Collections lens grouped by record group, with its **Group** and **Sort** menus; the Classes lens sorted by class number; a collection's detail (pushed) with its citing volumes. |
