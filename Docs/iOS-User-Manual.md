...
- **Collections** — the same archival collection index the Source Explorer uses (every collection in the bundled cross-volume authority, searchable), grouped by **repository** or by National Archives **record group**, opening each collection's full record: its NARA catalog link, related collections, when the series cited it, and every citing volume — tap one to browse it without losing your place.
