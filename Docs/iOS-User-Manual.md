...
**Quotation marks.** Straight (`"cold war"`), curly (`“cold war”`, `„cold war“`) and guillemet (`«cold war»`) quotation marks all make a phrase, so a phrase typed with Smart Punctuation on, or pasted from a document, is searched as the phrase it is.
