...
- **Pre-1910 Central Files** — 1906–1910 Numerical File rolls and the pre-1906 country-arranged diplomatic series, back through the 19th century — resolve from a **bundled index, no API key required**.
