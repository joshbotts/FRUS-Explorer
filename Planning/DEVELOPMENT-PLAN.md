...
- **Remaining backlog**: Phase 3 (Search/Analytics/Source Explorer in the detail pane) and the rest of Phase 5 (cross-ref-graph window, `supportsMultipleWindows` cleanup). `TabSection` grouping for sidebar section headers is a possible future enhancement.
