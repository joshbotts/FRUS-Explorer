...
sys.path.insert(0, "/private/tmp/claude-501/-Users-jbotts-Development-FRUS-Explorer--claude-worktrees-234-feasibility-assessment-518fe5/1ccebcd5-11bc-42dd-8b13-b2025658e2f3/scratchpad/chapter-context/coverage")
...
def main():
    ...
    json.dump(out, open(os.path.join(HERE, os.environ["LABEL"] + "-chapter-rule.json"), "w"), indent=1, sort_keys=True, default=list)
