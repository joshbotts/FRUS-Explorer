...
struct ArchivalNeighborsWindowView: View {
    ...
    var body: some View {
        #if os(iOS)
        // iPad windows have no title bar of their own — the nav bar is the chrome. `.auxWindowOrigin`
        // republishes the launching window's scene so a row-tap document routes back to it (#338).
