...
struct SeriesProductionDashboard: View {
    ...
    private var lagChart: some View {
        ...
        return chartCard(
            ...
            Chart {
                ...
                ForEach(data.lagPoints) { point in
                    PointMark(
                        x: .value(
    ...
    private var perYearChart: some View {
        ...
        return chartCard(
            ...
            Chart {
                ForEach(data.volumesPerPrintYearByEra) { bucket in
                    BarMark(
                        x: .value(
    ...
    private var coverageGanttChart: some View {
        ...
        return chartCard(
            ...
            Chart {
                ForEach(data.coverageSpans) { span in
                    BarMark(
                        xStart: .value(
    ...
    private var cumulativeChart: some View {
        ...
        return chartCard(
            ...
            Chart {
                ForEach(data.cumulativeByPrintYear) { point in
                    AreaMark(
                        x: .value(
