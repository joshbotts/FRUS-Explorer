...
struct FRUSSettingsView: View {
    ...
    // MARK: - Volumes tab
    // Uses NavigationSplitView: sidebar lists panels, detail shows the selected one.
    // This is the reliable macOS settings pattern: no NavigationStack push/pop needed.
