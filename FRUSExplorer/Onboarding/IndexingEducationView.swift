        ...
        sections: [
            ...
            EducationSection(
                ...
                paragraphs: [
                    ...
                    "Find it from the Browse tab\u{2019}s Analysis Tools menu (iOS) or the Archival Analytics window (Mac), and from the \u{201C}Open Archival Analytics\u{201D} link on the Archival Sourcing page of this guide."
                ]
            ),
            EducationSection(
                id: "source-explorer",
