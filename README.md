...
See `CLAUDE.md` for the full generator catalogue (central files, person authority,
volume sources, collection authority, source provenance, administration profiles)
and each tool's environment variables.
